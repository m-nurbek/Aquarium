...
public class Aquarium extends JFrame {
	...
	public void addContents() {
		...
		dPanel.addDrawableItem(new Fish(dPanel, "Clownfish.gif", 3, 4, false));
		dPanel.addDrawableItem(new Fish(dPanel, "PezTropical.gif", 5, 4, true));
		dPanel.addDrawableItem(new Fish(dPanel, "tropical.gif", 4, 5, true));
